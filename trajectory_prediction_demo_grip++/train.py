...
from utils.data_process import preprocess_data, compute_RMSE, data_loader
...
work_dir = './result/trained_models'
...
def run_trainval(pra_model, pra_traindata_path):
...
if __name__ == '__main__':
	...
	run_trainval(model, pra_traindata_path='result/processed_files/train_val_data.pkl')
